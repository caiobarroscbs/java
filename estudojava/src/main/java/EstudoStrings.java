...
public class EstudoStrings {
    public static void main(String[] args) {
        ...
        if(nome == "Pedro") { // comparada o endereço
        ...
        if (sobrenome == "Pereira") { // aqui compara o conteúdo das strings
            System.out.println("São iguais");
        } else {
            System.out.println("São diferentes");
        }

        // sobrenome.equalsIgnoreCse("pereira"); // ignora maiusculo e minusculo
        ...
        if (seuNome.toUpperCase().equals("JOSÉ")){
            System.out.println("EU NOME É JOSÉ");
        }
